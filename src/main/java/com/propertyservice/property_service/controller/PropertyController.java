...
public class PropertyController {
    ...
    public ResponseEntity<ApiResponseDto<List<PropertySummaryResponse>>> searchPropertySummaryList(PropertySearchCondition condition) {
    ...
    public ResponseEntity<ApiResponseDto<List<BuildingSummaryResponse>>> searchBuildingSummaryList(BuildingSearchCondition condition) {
    ...
    @Operation(summary = "건물 상세 조회", description = "건물의 상세정보를 조회합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "success",
                    content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "400", description = "Checked Error",
    ...
    public ResponseEntity<ApiResponseDto<BuildingDetailResponse>> searchBuildingDetail(@PathVariable Long buildingId) {
